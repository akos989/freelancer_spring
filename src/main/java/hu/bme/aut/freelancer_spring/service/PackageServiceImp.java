...
public class PackageServiceImp implements PackageService {
    ...
    public boolean delete(Long id) {
        ...
        if (pack.isEmpty()) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Package was not found with id: " + id);
        }
    ...
    public boolean changeStatus(Long packageId, Status status) {
        ...
        if (pack.isEmpty()) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Package was not found with id: " + packageId);
        }
        var p = pack.get();
        p.setStatus(status);
